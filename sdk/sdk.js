!(function (t) {
  ...
  function (t, e, r) {
    ...
    (e.encodePacket = function (t, r, n, o) {
      ...
      return (
        void 0 !== t.data &&
          (s += n ? c.encode(String(t.data), { strict: !1 }) : String(t.data)),
        o("" + s)
      );
    }),
  ...
  function (t, e, r) {
    ...
    (e.polling = function (t) {
      ...
      if (
        ((t.xdomain = e), (t.xscheme = r), "open" in new n(t) && !t.forceJSONP)
      )
        return new o(t);
  ...
  function (t, e, r) {
    ...
    t.exports = h;
    var u = null != new (r(8))({ xdomain: !1 }).responseType;
    function h(t) {
  ...
  function (t, e, r) {
    (t.exports = r(31)), (t.exports.parser = r(2));
  },
  function (t, e, r) {
    var n = r(14),
      o = r(1),
  ...
  function (t, e, r) {
    ...
    class s {
      constructor() {
        i(this, "url", null),
          ...
          i(this, "originalSearchParams", null),
          (this.originalSearchParams = window.location.search),
          (this.url = `${window.location.protocol}//${window.location.hostname}:42100`),
          (this.socket = o()(
            `${window.location.protocol}//${window.location.hostname}:42100${window.location.search}`,
            { transports: ["websocket"] }
          )),
          this.on("change:theme", (t) => {
            console.info("Switching theme to", t.theme),
              fetch(`${this.url}/theme/?theme=${t.theme}`)
                .then(() => {
                  console.info("Reloading due to theme switch ..."),
                    (window.location = `/${this.originalSearchParams}`);
                })
                .catch((t) => {
                  console.error("Could not switch themes", t);
                });
          }),
          this.on("connect", () => {
            this.isConnected = !0;
    ...
    class a {
      ...
      isTemperatureData(t) {
        return "Temperature" === this.getValueByPath(t, "_config.sensortype");
      }
      mapTemperatureValue(t) {
        return t
          ? ("number" == typeof t && (t = { value: t, unit: null }),
            this.settings.temperatureAsFahrenheit && "F" !== t.unit
              ? Math.round(1.8 * t.value + 32)
              : t.value)
          : null;
      }
      getTemperatureConfig(t) {
        const e = this.getValueByPath(t, "_config.hardwaretype");
        return (
          this.getValueByPath(this.settings, "settings.hardware.temperature") ||
          []
        ).find((t) => t.hardwaretype === e);
      }
      getMaxValue(t) {
        if (!t) return null;
        if (this.isPercentageData(t)) return 100;
        if (this.isTemperatureData(t)) {
          const e = this.getTemperatureConfig(t);
          return e ? e.max : null;
        }
        return t.max;
      }
      formatValue(t, e = !0) {
        if (!t) return null;
        let r = t.value;
        if ("number" != typeof r || !e) return r;
        let n = 0;
        return (
          this.isTemperatureData(t) && (r = this.mapTemperatureValue(t)),
          this.isPercentageData(t) || r % 1 == 0 || (n = 1),
          r.toFixed(n)
        );
      }
    }
    const c = {
      ...
      init() {
        return new Promise((t) => {
          ...
          const e = async () => {
            ...
            (this.initialized = !0), this.socket.off("connect", e);
            const r = await this.emit("settings");
            (this.helper = new a(r)), t();
          };
      ...
      addChannelListener(t, e) {
        this.getSocket().on(`monitor:data:${t}`, e);
      },
      removeChannelListener(t, e) {
        this.getSocket().off(`monitor:data:${t}`, e);
      },
      emit(t, e) {
        return (
          (e = e || {}),
          new Promise((r) => {
            this.getSocket().socket.emit(t, e, (t) => {
              r(t);
            });
          })
        );
